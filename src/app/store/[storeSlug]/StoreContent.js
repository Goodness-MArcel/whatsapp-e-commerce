...
//                   ) : (
//                     // List View
//                     <div className="d-flex flex-column gap-3  border border-primary">
//                       {filteredProducts.map((product) => (
//                         <div
//                           key={product.id}
...
import { useCart } from "../../context/CartContext";
import CompactCart from "../../components/CartSidebar";
import ProductModal from "../../components/ProductModal"; // We'll create this
import {
  Search,
  ShoppingCart,
  Heart,
      ...
      <div className="bg-light min-vh-100">
          ...
          <div className="row">
            ...
            <div className="col-lg-9">
              ...
              {filteredProducts.length === 0 ? (
                ...
                <>
                  {/* Products Grid View - SHORTER CARDS */}
                  {viewMode === "grid" ? (
                    <div className="row g-3">
                      {filteredProducts.map((product) => (
                        <div key={product.id} className="col-6 col-md-4">
                          <div className="card h-100 border-0 shadow-sm product-card-compact">
                            ...
                            >
                              ...
                              <button 
                                className="position-absolute top-0 end-0 btn btn-light btn-sm m-2 rounded-circle"
                            ...
                            <div className="card-body p-3">
                              <div onClick={(e) => openProductModal(product, e)} style={{ cursor: "pointer" }}>
                              ...
                              <div className="d-flex align-items-center gap-1 mb-2">
                                ...
                                <small className="text-secondary ms-1">(0)</small>
                              </div>
                      ...
                      {filteredProducts.map((product) => (
                        ...
                        >
                          <div className="row g-0 align-items-center">
                            <div className="col-2">
                              <div 
                                className="bg-light d-flex align-items-center justify-content-center rounded-3"
                              ...
                              >
                                {product.image ? (
                                  ...
                                  <Package size={30} className="text-secondary opacity-50" />
                                )}
                              </div>
                            </div>
                            <div className="col-7">
                              ...
                              <div className="d-flex align-items-center gap-1 mt-1">
                                {[...Array(5)].map((_, i) => (
                                  <Star
                                    key={i}
                                    size={10}
                                    className={i < Math.floor(4.5) ? "text-warning" : "text-secondary"}
                                  />
                                ))}
                              </div>
                            </div>
        ...
        <style jsx>{`
          ...
          .product-card-compact:hover {
            ...
            box-shadow: 0 12px 24px -8px rgba(0, 100, 80, 0.15) !important;
          }
